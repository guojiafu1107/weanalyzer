...
COMMENT ON TABLE articles IS '文章基础信息表';
...
COMMENT ON TABLE article_analysis IS '文章AI分析结果表';
...
COMMENT ON TABLE ai_suggestions IS 'AI建议日志表';
...
CREATE TRIGGER trg_accounts_updated_at BEFORE UPDATE ON accounts
    FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
COMMENT ON TABLE accounts IS '公众号账号表';
